...
const generateComponent = (componentName) => {
  ...
  fs.writeFile(
    `${__dirname}/../src/components/${componentName}/${componentName}.scss`,
    scss,
    errHandler
  );
  fs.writeFile(
    `${__dirname}/../src/components/${componentName}/${componentName}.js`,
    JSX,
    errHandler
  );
  fs.writeFile(
    `${__dirname}/../src/components/${componentName}/index.js`,
    index,
    errHandler
  );
  fs.writeFile(
    `${__dirname}/../src/stories/${componentName}.stories.js`,
    storybook,
    errHandler
  );
};
